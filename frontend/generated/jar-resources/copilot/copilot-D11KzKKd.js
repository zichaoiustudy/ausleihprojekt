...
}, S = /* @__PURE__ */ $r(Fr, oa), Kr = "computed", aa = "computed.struct", gn = /* @__PURE__ */ Dn(Kr), sa = /* @__PURE__ */ Dn(aa, {
...
var Cn = "action", Sa = "action.bound", ri = "autoAction", Na = "autoAction.bound", ii = "<unnamed action>", mn = /* @__PURE__ */ gt(Cn), xa = /* @__PURE__ */ gt(Sa, {
  bound: !0
}), yn = /* @__PURE__ */ gt(ri, {
  autoAction: !0
}), Pa = /* @__PURE__ */ gt(Na, {
...
function li(e, t, n) {
  ...
  var a = (r = n.name) != null ? r : process.env.NODE_ENV !== "production" ? "Reaction@" + B() : "Reaction", l = ye(a, n.onError ? Ca(n.onError, t) : t), s = !n.scheduler && !n.delay, c = si(n), u = !0, d = !1, v, g = n.compareStructural ? Ie.structural : n.equals || Ie.default, _ = new ee(a, function() {
    u || s ? w() : d || (d = !0, c(w));
...
const xe = "copilot-", as = "24.5.2", Ul = "attention-required", zl = "https://plugins.jetbrains.com/plugin/23758-vaadin", Bl = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Hl = (e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom, ss = (e) => {
  const t = [];
  let n = cs(e);
  for (; n; )
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ws, defineProperty: Es, getOwnPropertyDescriptor: Os, getOwnPropertyNames: As, getOwnPropertySymbols: Ss, getPrototypeOf: Ns } = Object, Qt = globalThis, dr = Qt.trustedTypes, xs = dr ? dr.emptyScript : "", Ps = Qt.reactiveElementPolyfillSupport, rt = (e, t) => e, On = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? xs : null;
      break;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ln = globalThis, It = Ln.trustedTypes, vr = It ? It.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, In = "$lit$", ie = `lit$${Math.random().toFixed(9).slice(2)}$`, Un = "?" + ie, Cs = `<${Un}>`, De = document, dt = () => De.createComment(""), ht = (e) => e === null || typeof e != "object" && typeof e != "function", zn = Array.isArray, ki = (e) => zn(e) || typeof e?.[Symbol.iterator] == "function", cn = `[ 	
\f\r]`, Ze = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, pr = /-->/g, gr = />/g, be = RegExp(`>|${cn}(?:([^\\s"'>=/]+)(${cn}*=${cn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), br = /'/g, _r = /"/g, Ti = /^(?:script|style|textarea|title)$/i, Vi = (e) => (t, ...n) => ({ _$litType$: e, strings: t, values: n }), Ut = Vi(1), Zl = Vi(2), he = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), mr = /* @__PURE__ */ new WeakMap(), we = De.createTreeWalker(De, 129);
function ji(e, t) {
...
const ks = { M: In, P: ie, A: Un, C: 1, L: Ri, R: Mi, D: ki, V: $e, I: en, H: mt, N: Ui, U: zi, B: Ii, F: Bi }, Ts = Ln.litHtmlPolyfillSupport;
...
}, Js = async () => Di(`${xe}get-user-info`, {}, (e) => (delete e.data.reqId, e.data)), Xs = async () => xi(() => b.userInfo), rc = async () => (await Xs()).vaadiner;
...
}, rl = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey, se = Qs(), ic = {
